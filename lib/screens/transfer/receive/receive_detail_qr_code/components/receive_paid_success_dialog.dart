        ...
        child: CustomDialog(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                Text(context.loc.transferReceivePaidSuccessHeader,
              ...
              children: [
                ...
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Text(context.loc.transferReceivePaidSuccessFrom,
                        style: Theme.of(context).textTheme.subtitle2),
                  ),
                ),
              ],
            ...
            Row(
              children: [
                Text(context.loc.transferReceivePaidSuccessDate,
                    style: Theme.of(context).textTheme.subtitle2),
            ...
            Row(
              children: [
                Text(context.loc.transferReceivePaidSuccessStatus,
                    style: Theme.of(context).textTheme.subtitle2),
                const SizedBox(width: 16),
                Container(
                  decoration: const BoxDecoration(
