...
class SwapEnterDataScreen extends StatelessWidget with RouteAware {
  ...
  Widget build(BuildContext context) {
    ...
    ObserverUtils.routeObserver
        .subscribe(this, ModalRoute.of(context)!); // how to dispose??
    ...
    return BlocListener<TransferExpertBloc, TransferExpertState>(
        ...
        listener: (context, state) {
          ...
          if (command is SwapPreset) {
            keyDeliverAmount.currentState!
                .pushText(args.swapDeliverAmount!.amountString());
            BlocProvider.of<TransferExpertBloc>(fromContext).add(
                OnSwapInputAmountChange(
                    newAmount: args.swapDeliverAmount?.amount ?? 9.9,
                    selected: "to",
                    otherKey: keySendAmount));
            ...
            NavigationService.of(context).navigateTo(Routes.sendConfirmation,
                command.arguments, true); // SendConfirmationScreen
        ...
        child: BlocBuilder<TransferExpertBloc, TransferExpertState>(
            ...
            builder: (context, state) {
              final proxySend =
                  state.selectedAccounts["from"] != settingsStorage.accountName;
              final sendingTokenDataModel = TokenDataModel.from(senderBalance,
                  token: state.swapSendAmount!.token);
              return Scaffold(
                  appBar: AppBar(
                    title: Text(
                        "Send Abroad"), //Text(context.loc.transferSendSearchTitle),
                    actions: [
                      IconButton(
                        ...
                        SingleChildScrollView(
                          child: Column(
                            ...
                            children: [
                              ...
                              SearchResultRow(
                                  member: ProfileModel.usingDefaultValues(
                              ...
                              AmountEntryWidget(
                                ...
                                onValueChange: (value) {
                                  ...
                                  if (newAmount != null &&
                                      deliverFieldHasFocus) {
                                    BlocProvider.of<TransferExpertBloc>(
                                            fromContext)
                                        .add(OnSwapInputAmountChange(
                                            newAmount: newAmount,
                                            selected: "to",
                                            otherKey: keySendAmount));
                                  }
                                ...
                                autoFocus:
                                    true, //state.pageState == PageState.initial,
                                fieldName: "to",
                              ...
                              Column(
                                children: [
                                  TextFormFieldLight(
                                    ...
                                    labelText:
                                        context.loc.transferMemoFieldLabel,
                                    ...
                                    onChanged: (String value) {
                                      BlocProvider.of<TransferExpertBloc>(
                                              fromContext)
                                          .add(
                                              OnMemoChange(memoChanged: value));
                                    },
                                  ),
...
///////////  Sending tokens
                              Column(
                                  ...
                                  children: [
                                        ...
                                        if (newAmount != null &&
                                          ...
                                          BlocProvider.of<TransferExpertBloc>(
                                              ...
                                              .add(OnSwapInputAmountChange(
                                                  newAmount: newAmount,
                                                  selected: "from",
                                                  otherKey: keyDeliverAmount));
                                        }
                                      },
                                      autoFocus:
                                          false, //state.pageState == PageState.initial,
                                      fieldName: "from",
                                      onFocusChanged: (hasFocus) {
                                    ...
                                    AlertInputValue(
                                        context.loc
                                            .transferSendNotEnoughBalanceAlert,
                                        isVisible:
                                            (state.swapSendAmount?.amount ??
                                                    0) >
                                                senderBalance!),
                                    const SizedBox(height: 16),
                                    BalanceRow(
                                        label: context
                                            .loc.transferSendAvailableBalance,
                                        fiatAmount:
                        ...
                        Align(
                          ...
                          child: FlatButtonLong(
                            ...
                            onPressed: () {
                              ...
                              BlocProvider.of<TransferExpertBloc>(fromContext)
                                  .add(OnSwapNextButtonTapped(state));
                            },
                          ),
                        ),
                      ])));
